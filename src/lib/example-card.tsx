 ...
 *
 * It is drawn twice: as the <img> on the homepage, and as the og:image for
 * every page that doesn't generate its own. Both go through here, because a
 * homepage that unfurls blank is a link nobody clicks — and famlove.lol is
 * the URL people paste most.
 */
const SHOWCASE_SLUG = "slashloop-dev";

export async function exampleCard(): Promise<ImageResponse> {
